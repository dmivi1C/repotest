...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Для каждого ТекСтрокаТовары Из Товары Цикл
		...
		ТекущийКоэффициент = ?(ТекСтрокаТовары.ЕдиницаИзмерения.Коэффициент > 0
			,ТекСтрокаТовары.ЕдиницаИзмерения.Коэффициент, 1); 
		Движение = Движения.ТоварныеЗапасы.Добавить();
		Движение.ВидДвижения = ВидДвиженияНакопления.Приход;
		Движение.Период = Дата;
		Движение.Товар = ТекСтрокаТовары.Товар;
		Движение.Склад = Склад;
		Движение.Количество = ТекСтрокаТовары.Количество * ТекущийКоэффициент;
